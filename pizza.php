...
<body>
    <h1>This is Pizza page for test</h1>
    ...
    <div class="body">
        ...
        <?php for ($i = 1; $i <= 12; $i++) { ?>
            <div class="flex">
                <div class="food_card">
                    <img src="https://b.zmtcdn.com/data/pictures/chains/7/19016907/1ffd4247f673f276e962940cabd41faf.jpg?output-format=webp&fit=around|771.75:416.25&crop=771.75:416.25;*,*"
                        alt="">
                ...
                <div class="food_card space">
                    <img src="https://b.zmtcdn.com/data/reviews_photos/087/e9013864248afc5ea801270d5a185087_1643985994.jpg?output-format=webp&fit=around|300:273&crop=300:273;*,*"
                        alt="">
                    <p>50% OFF up to 100 41 min</p>
                    <p style="border-bottom: 1px solid grey;">Shree Balaji South Indian Food</p>
                    <p>South Indian</p>
                ...
                <div class="food_card space">
                    <img src="https://b.zmtcdn.com/data/pictures/chains/2/20578762/e779b1c340bf9bce14e46fbf45f9f985.jpg?output-format=webp&fit=around|771.75:416.25&crop=771.75:416.25;*,*"
                        alt="">
                    <p>50% OFF up to 100 41 min</p>
                    <p style="border-bottom: 1px solid grey;">Shree Balaji South Indian Food</p>
                    <p>South Indian</p>
