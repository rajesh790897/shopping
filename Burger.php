...
<body>
    <h1>This is Burger page for roll</h1>
    ...
    <div class="body">
        ...
        <?php for ($i = 1; $i <= 8; $i++) { ?>
            <div class="flex">
                <div class="food_card">
                    <img src="https://b.zmtcdn.com/data/pictures/6/19648676/c41f54c9f6fe376af1f3a55aacf9335d.jpg?output-format=webp&fit=around|771.75:416.25&crop=771.75:416.25;*,*"
                        alt="">
                ...
                <div class="food_card space">
                    <img src="https://b.zmtcdn.com/data/dish_photos/1ef/dd70f750d38f6f1f70785eb52ee631ef.png?output-format=webp&fit=around|130:130&crop=130:130;*,*"
                        alt="">
                    <p>50% OFF up to 100 41 min</p>
                    <p style="border-bottom: 1px solid grey;">Shree Balaji South Indian Food</p>
                    <p>South Indian</p>
                ...
                <div class="food_card space">
                    <img src="https://b.zmtcdn.com/data/pictures/chains/1/19608391/6f7e49aa649bf83d94f5af5b07aef0e1.jpg?fit=around|771.75:416.25&crop=771.75:416.25;*,*"
                        alt="">
                    <p>50% OFF up to 100 41 min</p>
                    <p style="border-bottom: 1px solid grey;">Shree Balaji South Indian Food</p>
                    <p>South Indian</p>
