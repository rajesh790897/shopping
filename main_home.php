...
<body>
    ...
    <div class="body">
        ...
        <p><a href="/ap/zomato/index.php" class="a"> Home </a>/<a href="#" class="a"> India </a>/<a href="#" class="a">
        ...
        <div class="body">
            <div class="flex">
                <div class="popular_food_card">
                    <a href="/ap/zomato/user/online_order/page/biryani.php"><img
    ...
    <div class="body">
        ...
        <div class="flex-res">
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                ...
                ?>
                <div class="food_card ">
                    <a href="/ap/zomato/user/online_order/restaurant.php?rid=<?php echo $row['seller_id']; ?>">
